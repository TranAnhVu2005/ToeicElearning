...
public enum ErrorCode {
    // 9999: Lỗi không xác định / Server Error
    UNCATEGORIZED_EXCEPTION(9999, "Đã có lỗi xảy ra từ phía hệ thống, vui lòng thử lại sau!", HttpStatus.INTERNAL_SERVER_ERROR),
